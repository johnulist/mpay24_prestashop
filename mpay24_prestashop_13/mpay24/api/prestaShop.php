    ...
    class prestaShop extends MPay24Shop {
        ...
        function updateTransaction($tid, $args, $shippingConfirmed){
            ...
            if($args['STATUS'] == 'OK'){
	            ...
	            echo "OK : " . PRESTASHOP_MODULE_VERSION . " The confirmation was evaluated!";
        } else {
              $order->setCurrentState(_PS_OS_ERROR_);
							echo "ERROR : " . PRESTASHOP_MODULE_VERSION . " The confirmation was NOT evaluated right!";
        }
        } 
        ...
        function createMDXI($transaction){
          ...
          $mdxi->Order->setLogoStyle(utf8_encode($this->designSettings['MPAY24_ORDER_LOGO_S']));
	        ...
	        $mdxi->Order->UserField = PRESTASHOP_MODULE_VERSION . " ".md5($transaction->TID.number_format($transaction->PRICE,2,'.','').$this->transaction->CURRENCY.$this->customer->id);
          ...
          $i = 1;
          if($this->shopSettings['MPAY24_PAYMENT_SYSTEMS_SHOP'] != $this->shopSettings['MPAY24_ACTIVE_PAYMENT_SYSTEMS']) {
          ...
          $mdxi->Order->URL->Success = $url . $_SERVER['SERVER_NAME']. _MODULE_DIR_ . "mpay24/backFromMpay24.php?customerID=".$this->customer->id."&amp;cartID=".(int)$this->cart->id;
          $mdxi->Order->URL->Error = $url . $_SERVER['SERVER_NAME']. _MODULE_DIR_ . "mpay24/backFromMpay24.php?customerID=".$this->customer->id."&amp;cartID=".(int)$this->cart->id;
          ...
          $mdxi->Order->URL->Cancel = $url . $_SERVER['SERVER_NAME']. _MODULE_DIR_ . "mpay24/backFromMpay24.php?TID=".$this->orderID."&amp;customerID=".$this->customer->id."&amp;cartID=".(int)$this->cart->id;
